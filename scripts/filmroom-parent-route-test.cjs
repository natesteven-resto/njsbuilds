...
const token=load('app/api/filmroom/video-token/route.ts',{'@/lib/filmroom-stream':{streamEnabled:()=>false},'@/lib/filmroom-supabase-server':auth,'@aws-sdk/client-s3':{S3Client:class{},GetObjectCommand:class{}},'@aws-sdk/s3-request-presigner':{getSignedUrl:async(a,b,o)=>{calls++;ttl=o.expiresIn;return 'https://example.test/signed'}}});
